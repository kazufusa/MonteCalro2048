	      ...
	      for (var _i = 0; _i < this.nrow; ++_i) {
	        for (var _j = 0; _j < this.ncol - 1; ++_j) {
	          if (this.position[_i][_j] === 0) {
	            for (var k = _j + 1; k < this.ncol; --k) {
	              if (this.position[_i][k] !== 0) return true;
	            }
	          }
	        }
	      }
	      ...
	      for (var _j3 = 0; _j3 < this.ncol; ++_j3) {
	        for (var _i3 = 0; _i3 < this.nrow - 1; ++_i3) {
	          if (this.position[_i3][_j3] === 0) {
	            for (var k = _j3 + 1; k < this.nrow; ++k) {
	              if (this.position[k][_j3] !== 0) {
	                return true;
	              }
	            }
	          }
	      ...
	      for (var _j4 = 0; _j4 < this.ncol; ++_j4) {
	        for (var _i4 = this.nrow - 1; _i4 >= 0; --_i4) {
	          if (this.position[_i4][_j4] === 0) {
	            for (var k = _i4 - 1; k >= 0; --k) {
	              if (this.position[k][_j4] !== 0) {
	                return true;
	              }
	            }
	          }
	      ...
	      for (var _i5 = 0; _i5 < this.nrow; ++_i5) {
	        for (var _j5 = 0; _j5 < this.ncol - 1; ++_j5) {
	          if (this.position[_i5][_j5] === 0) {
	            for (var k = _j5 + 1; k < this.ncol; ++k) {
	              if (this.position[_i5][k] !== 0) {
	                this.position[_i5][_j5] = this.position[_i5][k];
	                this.position[_i5][k] = 0;
	                ret = true;
	                break;
	              }
	            }
	      ...
	      for (var _i6 = 0; _i6 < this.nrow; ++_i6) {
	        for (var _j6 = this.ncol - 1; _j6 >= 0; --_j6) {
	          if (this.position[_i6][_j6] === 0) {
	            for (var k = _j6 - 1; k >= 0; --k) {
	              if (this.position[_i6][k] !== 0) {
	                this.position[_i6][_j6] = this.position[_i6][k];
	                this.position[_i6][k] = 0;
	                ret = true;
	                break;
	              }
	            }
	      ...
	      for (var _j7 = 0; _j7 < this.ncol; ++_j7) {
	        for (var _i7 = 0; _i7 < this.nrow - 1; ++_i7) {
	          if (this.position[_i7][_j7] === 0) {
	            for (var k = _j7 + 1; k < this.nrow; ++k) {
	              if (this.position[k][_j7] !== 0) {
	                this.position[_i7][_j7] = this.position[k][_j7];
	                this.position[k][_j7] = 0;
	                ret = true;
	                break;
	              }
	            }
	      ...
	      for (var _j8 = 0; _j8 < this.ncol; ++_j8) {
	        for (var _i8 = this.nrow - 1; _i8 >= 0; --_i8) {
	          if (this.position[_i8][_j8] === 0) {
	            for (var k = _i8 - 1; k >= 0; --k) {
	              if (this.position[k][_j8] !== 0) {
	                this.position[_i8][_j8] = this.position[k][_j8];
	                this.position[k][_j8] = 0;
	                ret = true;
	                break;
	              }
	            }
